...
const AccountHeadTypeList = ({searchParams}) => {
    ...
    //     if (proceed) {
    //         fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/account_head_type/account_head_type_delete/${id}`, {
    //             method: "POST",
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/account_head_type/account_head_type_all_paigination/${currentPage}/${dataPerPage}`;
