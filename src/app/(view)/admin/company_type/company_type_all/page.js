...
const CompanyTypeList = ({ searchParams }) => {
  ...
  const caregory_list = async () => {
    const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/company_type/company_type_list_paigination/${currentPage}/${dataPerPage}`;
  ...
  const photogalleryCategoryAll_delete = (id) => {
    ...
    fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/Admin/company_type/company_type_delete/${id}`,
      {
        method: "POST",
      }
    )
