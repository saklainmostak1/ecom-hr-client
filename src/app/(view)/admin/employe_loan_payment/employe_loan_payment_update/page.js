...
//         queryFn: async () => {
//             const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/employe_loan_payment/employe_loan_payment_all/${id}`);
...
//         fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/employe_loan_payment/employe_loan_payment_update/${id}`, {
//             method: 'POST',
//             headers: {
