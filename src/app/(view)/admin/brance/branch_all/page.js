...
const BranchList = ({searchParams}) => {
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/branch/branch_list/${currentPage}/${dataPerPage}`;
    ...
    const branch_delete = id => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/branch/branch_delete/${id}`, {
            method: "POST",
        })
            .then(response => {
