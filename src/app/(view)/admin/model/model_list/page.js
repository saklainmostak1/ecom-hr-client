...
const ModelList = ({searchParams}) => {
    ...
    const model_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/model/model_delete/${id}`, {
                method: "POST",
 ...
 const model_search = () => {
     setLoading(true);
     axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/model/model_search`, {
         multiSearch,
         selectedColumns,
         searchQuery,
         statusFilter,
...
const all_models = async () => {
 const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/model/model_all/${currentPage}/${dataPerPage}`;
...
const activePage = searchParams?.page ? parseInt(searchParams.page) : 1;
    ...
    const model_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/model/model_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
...
const model_word_download = async () => {
    ...
    const model_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/model/model_delete/${id}`)
                .then(response => {
    ...
    const model_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/model/model_pdf`, {
                method: 'POST',
                headers: {
