...
const QuotationLists = ({ searchParams }) => {
    ...
    const { data: loanAll = [], isLoading, refetch
        ...
        queryKey: ['loanAll'],
        queryFn: async () => {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list`)
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_paigination/${currentPage}/${dataPerPage}`;
    ...
    const loan_delete = id => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_delete/${id}`, {
            method: "POST",
        })
            .then(response => {
    ...
    const loan_search = () => {
        ...
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_search`, {
    ...
    const loan_pdf_download = async () => {
        ...
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_search`, {
            toDate, fromDate, product_id, name, mobile, invoice
        });
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_pdf`, {
                method: 'POST',
                headers: {
    ...
    const loan_print = async () => {
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_print`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const sale_print_single = async (id) => {
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_print_single`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const sale_pdf_download_single = async (id) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_pdf_single`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const sale_print_all = async () => {
        ...
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_list_print_all`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
