...
const UpdateQuotation = ({ id }) => {
    ...
    const { data: saleProductSingle = [] } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_single/${id}`);
...
`;
    ...
    const purchase_create = (event) => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_edit/${id}`, {
            method: 'POST',
            headers: {
    ...
    const unit_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/quotation/quotation_product_delete/${id}`, {
                method: "POST",
    ...
    const { data: purchase_product_list_ware_house = [],
        ...
        queryFn: async () => {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/purchase_product/purchase_product_list_ware_house`)
