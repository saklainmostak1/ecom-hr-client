...
const LoanLists = ({ searchParams }) => {
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/loan/loan_all_paigination/${currentPage}/${dataPerPage}`;
    ...
    const loan_delete = id => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan/loan_delete/${id}`, {
            method: "POST",
        })
            .then(response => {
    ...
    const loan_search = () => {
        ...
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan/loan_search`, {
    ...
    const loan_pdf_download = async () => {
        ...
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan/loan_search`, {
            toDate, fromDate, account_heads, loanAuthority, loan_type, status
        });
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan/loan_pdf`, {
                method: 'POST',
                headers: {
    ...
    const loan_print = async () => {
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan/loan_print`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
