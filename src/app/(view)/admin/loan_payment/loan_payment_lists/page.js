...
const LoanPaymentLists = ({ searchParams }) => {
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/loan_payment/loan_payment_list_paigination/${currentPage}/${dataPerPage}`;
    ...
    const loan_delete = id => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan_payment/loan_payment_delete/${id}`, {
            method: "POST",
        })
            .then(response => {
    ...
    const loan_search = () => {
        ...
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan_payment/loan_payment_search`, {
    ...
    const loan_payment_pdf = async () => {
        ...
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan_payment/loan_payment_search`, {
            toDate, fromDate, account_heads, loan_type, status
        });
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan_payment/loan_payment_pdf`, {
                method: 'POST',
                headers: {
    ...
    const loan_payment_print = async () => {
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/loan_payment/loan_payment_print`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
